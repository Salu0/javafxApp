...
/**
 * Buffer contains code to read and read packets from/to the MySQL server.
 */
public class Buffer {
    ...
    /**
     * Returns the current position to read to/ read from
     * 
     * @return the current position to read to/ read from
     */
    ...
    /**
     * Set the current position to read to/ read from
     * 
     * @param position
