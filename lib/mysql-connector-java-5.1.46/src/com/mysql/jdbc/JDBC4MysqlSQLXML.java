...
public class JDBC4MysqlSQLXML implements SQLXML {
    ...
    private synchronized void checkWorkingWithResult() throws SQLException {
        if (this.workingWithResult) {
            throw SQLError.createSQLException("Can't perform requested operation after getResult() has been called to read XML data",
    ...
    /**
     * Retrieves a stream that can be used to read the XML value that this
    ...
    /**
     * Retrieves a stream to be used to read the XML value that this SQLXML
