...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_DUP_KEY = 1022; //SQLSTATE: 23000 Message: Can't read; duplicate key in table '%s'
    ...
    public final static int ER_DUP_UNIQUE = 1169; //SQLSTATE: 23000 Message: Can't read, because of unique constraint, to table '%s'
    ...
    public final static int ER_WRONG_LOCK_OF_SYSTEM_TABLE = 1428; //SQLSTATE: HY000 Message: You can't combine read-locking of system tables with other tables or lock types
    ...
    public final static int ER_CANT_WRITE_LOCK_LOG_TABLE = 1555; //SQLSTATE: HY000 Message: You can't read-lock a log table. Only read access is possible
    ...
    public final static int ER_SLAVE_RELAY_LOG_WRITE_FAILURE = 1595; //SQLSTATE: HY000 Message: Relay log read failure: %s
    ...
    public final static int ER_BINLOG_ROW_ENGINE_AND_STMT_ENGINE = 1661; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since both row-incapable engines and statement-incapable engines are involved.
    public final static int ER_BINLOG_ROW_MODE_AND_STMT_ENGINE = 1662; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since BINLOG_FORMAT = ROW and at least one table uses a storage engine limited to statement-based logging.
    public final static int ER_BINLOG_UNSAFE_AND_STMT_ENGINE = 1663; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since statement is unsafe, storage engine is limited to statement-based logging, and BINLOG_FORMAT = MIXED. %s
    public final static int ER_BINLOG_ROW_INJECTION_AND_STMT_ENGINE = 1664; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since statement is in row format and at least one table uses a storage engine limited to statement-based logging.
    public final static int ER_BINLOG_STMT_MODE_AND_ROW_ENGINE = 1665; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since BINLOG_FORMAT = STATEMENT and at least one table uses a storage engine limited to row-based logging.%s
    public final static int ER_BINLOG_ROW_INJECTION_AND_STMT_MODE = 1666; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since statement is in row format and BINLOG_FORMAT = STATEMENT.
    public final static int ER_BINLOG_MULTIPLE_ENGINES_AND_SELF_LOGGING_ENGINE = 1667; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since more than one engine is involved and at least one engine is self-logging.
    ...
    public final static int ER_BINLOG_STMT_MODE_AND_NO_REPL_TABLES = 1844; //SQLSTATE: HY000 Message: Cannot execute statement: impossible to read to binary log since BINLOG_FORMAT = STATEMENT, and both replicated and non replicated tables are written to.
    ...
    public final static int ER_TEMP_FILE_WRITE_FAILURE = 1878; //SQLSTATE: HY000 Message: Temporary file read failure.; was introduced in 5.7.3.
