...
public class ConnectionTest extends BaseTestCase {
    ...
    public void testUseCompress() throws Exception {
        ...
        if (versionMeetsMinimum(5, 6, 20) && !versionMeetsMinimum(5, 7)) {
             ...
             * As a result of the redo log BLOB read limit introduced for MySQL 5.6, innodb_log_file_size should be set to a value
        ...
        if (versionMeetsMinimum(5, 6, 5)) {
            try {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    notLocalState.createStatement().execute("set session transaction read read");
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    assertTrue(StandardLogger.getBuffer().toString().indexOf("set session transaction read read") != -1);
